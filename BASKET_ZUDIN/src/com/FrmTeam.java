...
public class FrmTeam extends javax.swing.JDialog {
    ...
    private void loadTeamsAsync() {
        lblStatus.setText("Загрузка команд...");
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (JOptionPane.showConfirmDialog(this, "Вы уверены, что хотите удалить выбранную команду?", "Подтверждение", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            Team selectedTeam = currentTeams.get(selectedRow);
            try {
